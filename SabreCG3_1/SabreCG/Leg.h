...
private:
	...
	vector<SubNode* > _subNodeList;		// 保存multi label
...
public:
	...
	bool resetLeg(); //* 删除_subNodeList里所有指针指向的subNode, 并删除_subNodeList所有的指针
	...
	bool insertSubNode(SubNode* subNode);	//* 将subNode与subNodeList中的subNode一一比较是否被dominate，插入subNodeList
